...
try{
    ...
    <button className="relative block overflow-hidden rounded-lg border border-gray-100 p-8">
      ...
      <div className="justify-between sm:flex">
        ...
        <div className="ml-3 hidden flex-shrink-0 sm:block relative">
          ...
          <Link to='/updateimage'>  <button className="bg-white p-2 rounded-full" >
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
      ...
      {/* edit user details */}
      <div className="absolute bottom-0 right-0 -mt-2 -mr-1">
      <Link to='/updateuser'>  <button className="bg-white p-2 rounded-half" >
