...
<div className="flex flex-col md:flex-row md:items-stretch md:h-screen ml-9">
  <div className="md:w-1/6 bg-white dark:bg-gray-700 md:border-r md:border-gray-200 md:rounded-lg">
    <div className="md:w-48 text-sm font-medium text-gray-900 dark:text-white">
